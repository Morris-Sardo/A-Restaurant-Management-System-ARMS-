...
public class Customer {
	 ...
	 */
	public ArrayList<Integer> viewMenu() throws PSQLException, SQLException, DatabaseInformationException {
	...
	/**
	 * Finds all items on the menu marked as available that fulfill the filter
	 * criteria.
	 * 
	 * @return the IDs corresponding to the menu items available
	 */
