...
public class Waiter {
    ...
    public String[] vieworders() {
        ...
        try {
            ...
            while (resultset.next()) {
                ...
                orders.add("Order Number: " + orderNumber + ", Table Number: " + tableNumber + ", Items: " + items + ", Status: " + status);
            }
    ...
    // after that i need to handle database interactions for methods like deliveredOrder, confirmOrder, etc.
