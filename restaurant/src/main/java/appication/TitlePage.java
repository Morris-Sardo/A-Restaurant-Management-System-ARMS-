...
public enum TitlePage {
   ...
   * This is second.
   */
  REVIEW_PAGE("Review Page Staff"), MENU_PAGE_COSTUMER("Menu Page Costumer"), INVENTROY_PAGE(
      "Inventory Page"), MAKE_REVIEW_PAGE("Make Review Page"), MENU_PAGE(
          "Menu Page"), DASHBOARD_PAGE(
